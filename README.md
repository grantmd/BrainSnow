...
* Parser: Where the magic happens. Accepts results from the Fetchers via the Server, parses them for whatever, and sends urls back to the Server for further fetching. You need *at least* one of these, probably more.
